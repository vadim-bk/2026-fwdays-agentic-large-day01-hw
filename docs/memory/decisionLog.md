...
- **Evidence**:
  - **Init-order DOM side-effect (theme flash prevention)**: `excalidraw-app/index.html` reads `localStorage("excalidraw-theme")` and toggles `document.documentElement.classList` *before* app init to minimize white flash.
